        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('index.php/suplier/hittambah') ?>" method="POST" >
                            <div class="row mb-3">
                                <div class="col-md-12">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input class="form-control" id="inputLastName" name="nama_perusahaan" type="text" value="" placeholder="Input Nama Perusahaan">

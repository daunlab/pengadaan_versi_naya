...
<html lang="en">
    ...
    <body class="bg-primary">
        <section class="vh-100" style="background-color: #119AE7;">
        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="<?php echo base_url("assets/assets/img/toko.png") ?>" width="464px" height="520px">
            </div>
              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form method="post" action="<?php echo base_url("index.php/hitlogin") ?>">
                  ...
                  <div class="d-flex align-items-center mb-3 pb-1">
                    <i class="fas fa-cubes fa-2x me-3" style="color: #182029;"></i>
                  ...
                  <div class="pt-1 mb-4">
                    <!-- <button name="login" class="btn btn-dark btn-lg btn-block" type="button">Login</button> -->

...
<html lang="en">
    <head>
        ...
        <title>Pembeli - Deran Kusen</title>
                ...
                <main>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <a class="btn btn-primary" href="<?= base_url('index.php/pembeli/tambah'); ?>">Tambah pembeli</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form id="formdel_<?= $i->id ?>" action='<?= base_url('index.php/pembeli/'.$i->id.'/hitremove')?>' method='POST'>
                                                    <input type='hidden' name='aksi' value="delete" >
                                                    <input type='hidden' name='id' value="<?= $i->id ?>" >
                                                </form>
                                                <a href="<?= base_url('index.php/pembeli/'.$i->id.'/edit') ?>" class="btn btn-warning btn-sm">Edit</a>
